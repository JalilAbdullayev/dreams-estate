<div id="accordion-collapse" class="accordion mt-12" data-accordion="collapse">
    <h2 id="accordion-collapse-heading-1">
        <button type="button" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true"
            ...
            <span class="text-[#0E0E46] bg-[#F7F6FF]">Overview</span>
    ...
    <h2 id="accordion-collapse-heading-2">
        <button type="button"
            ...
            <span class="text-[#0E0E46] bg-[#F7F6FF]">Description</span>
            <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                      stroke-width="2" d="M9 5 5 1 1 5"/>
    ...
    <div id="accordion-collapse-body-2" class="hidden"
        ...
        <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
            <p class="mb-2 text-gray-500 dark:text-gray-400">Good road frontage on a paved
            ...
            <p class="text-gray-500 dark:text-gray-400">This property is mostly wooded and sits
                high on a hilltop overlooking the Mohawk River Valley. Located right in the
                heart of Upstate NYs Amish farm Country, this land is certified organic making
                it extremely rare! Good road frontage on a paved county road with utilities make
                it an amazing setting for your dream country getaway! If you like views, you
                must see this property!This property is mostly wooded and sits high on a hilltop
                overlooking the Mohawk River Valley. Located right in the heart of Upstate NYs
                Amish farm Country, this land is certified organic making it extremely rare!
                Good road frontage on a paved county road with utilities make it an amazing
                setting for your dream country getaway! If you like views, you must see this
                property!</p>
        </div>
    </div>
    <h2 id="accordion-collapse-heading-3">
        <button type="button"
                ...
                aria-controls="accordion-collapse-body-2">
            <span class="text-[#0E0E46] bg-[#F7F6FF]">Property Address</span>
            <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                      stroke-width="2" d="M9 5 5 1 1 5"/>
    ...
    <h2 id="accordion-collapse-heading-4">
        <button type="button"
                ...
                aria-controls="accordion-collapse-body-2">
            <span class="text-[#0E0E46] bg-[#F7F6FF]">Property Details</span>
            <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                      stroke-width="2" d="M9 5 5 1 1 5"/>
    ...
    <div id="accordion-collapse-body-4" class="hidden"
        ...
        <div
            class="flex justify-between p-5 border border-b-0 border-gray-200 dark:border-gray-700">
            <div>
